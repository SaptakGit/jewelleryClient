...
const WishListRow = ({myWish, handleAddToWishList}) => {
    //console.log(myWish);
    ...
    return (
        <div className="flex flex-col md:flex-row gap-4 border-b pb-4">
              ...
              <div className="flex-1 space-y-1">
                ...
                <p>Code: <span className='btn btn-active btn-secondary btn-sm ml-2'>{productId.productCode}</span></p>
                ...
                <div className="flex gap-4 text-sm text-gray-600 underline mt-1">
                  <a href="#" onClick={(e) => { e.preventDefault(); handleAddToWishList(productId); }}>Remove From Wishlist</a>
                </div>
              </div>
